...
const Footer = () => {
  ...
  return (
    <footer className="pt-[40px] pb-[60px]">
      <div className="footer-container max-w-[1200px] flex mx-auto justify-between px-5 xl:px-0">
        <div className="left flex flex-col w-full max-w-[400px] pr-5">
          <Logo></Logo>
          ...
          <a
            ...
            className="mb-4"
          >
            <span className="font-semibold text-[#475467]">Group:</span> Cộng
            đồng eCommerce Club @ UIT
          </a>
        </div>
        <div className="right mr-0 ml-auto">
          <div className="list grid grid-cols-5 gap-[30px] md:grid-cols-3 lg:grid-cols-5">
