...
const PaginationArrow = ({ pagination, onPageChange }) => {
  ...
  return (
    <>
      <div className="flex items-center justify-center gap-x-2 absolute -bottom-[70px] left-1/2 -translate-x-1/2 ">
        <button
          className={`arrow flex justify-center items-center w-[30px] h-[30px] rounded-full mr-5 ${
        ...
        <button
          className={`arrow flex justify-center items-center w-[30px] h-[30px] rounded-full ml-5 ${
