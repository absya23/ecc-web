...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <section className="w-full intro-news px-[100px] mb-20 flex flex-col">
        <p className="font-bold text-note">Thông báo</p>
        <h3 className="mb-8 text-2xl font-title">Hoạt động và sự kiện</h3>
